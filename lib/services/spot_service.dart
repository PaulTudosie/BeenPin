...
class SpotService {
  ...
  static Spot? findSpotByIdOrName({
    ...
    final normalizedTarget = _normalizeSpotLookupValue(spotName);
  ...
  static String? resolveSpotId({
    String? spotId,
    String? spotName,
  }) {
    return findSpotByIdOrName(
      spotId: spotId,
      spotName: spotName,
    )?.id;
  }

  static String? _normalizeSpotLookupValue(String? value) {
